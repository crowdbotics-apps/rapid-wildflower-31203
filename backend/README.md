...
## Project Structure
    ...
    ├── rapid_wildflower_31203  # Django project configurations
...
1. Clone this repo and `cd rapid_wildflower_31203`
...
2. Clone this repo and `cd rapid_wildflower_31203`
